...
a = LinkedInPeopleProfileSpider()
response = a.start_requests()
borja = list(response)[0]
profile = a.parse_profile(borja)

for item in profile:
    print(item)

profile = "borja-e-98228088"
response = requests.get(f"https://www.linkedin.com/in/borja-e-98228088/")